...
<section class="quick-view">
   ...
   <h1 class="title">anteprima prodotto</h1>
   ...
   <form action="components/add_to_cart.php" method="post" class="box">
      ...
      <button type="submit" name="add_to_cart" class="cart-btn">aggiungi al carrello</button>
   </form>
   <?php
         }
      }else{
         echo '<p class="empty">il prodotto non è più presente</p>';
      }
      $stmt->close();
   ?>
